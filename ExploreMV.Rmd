...
But the above thows and error: `Error in match.names(clabs, names(xi)) : names do not match previous names`

The problem is `DAYNIGHT` in archive but not nrt and `TYPE` _vice versa_. We need common variables to be able to bind rows
```{r}
