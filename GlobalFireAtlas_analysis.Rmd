...
for(scenario in scenario_list){
  ...
  for(grp in c("JanApr","AllYear")){
    ...
    po <- read_csv(paste0("Data/MODIS/Global_Fire_Atlas/PixelOverlap_",grp,"_",scenario,"-offset-LTRp1.csv"), 
                   col_select=-1, 
...
write_csv(counts_tbl, "Data/MODIS/Global_Fire_Atlas/PixelOverlap_Counts-offset-LTRp1.csv")
write_csv(props_tbl, "Data/MODIS/Global_Fire_Atlas/PixelOverlap_Props-offset-LTRp1.csv")
...
countsDat <- read_csv(paste0("Data/MODIS/Global_Fire_Atlas/PixelOverlap_Counts-offset-LTRp1.csv"))

pdf("Data/MODIS/Global_Fire_Atlas/Hits_PixelOverlap-offset-LTRp1.pdf", width=10, height=10)
plotCounts(countsDat, "hits")
dev.off()

pdf("Data/MODIS/Global_Fire_Atlas/Misses_PixelOverlap-offset-LTRp1.pdf", width=10, height=10)
plotCounts(countsDat, "misses")
dev.off()

pdf("Data/MODIS/Global_Fire_Atlas/FAlarms_PixelOverlap-offset-LTRp1.pdf", width=10, height=10)
...
```{r, run-props-plots}
propsDat <- read_csv(paste0("Data/MODIS/Global_Fire_Atlas/PixelOverlap_Props-offset-LTRp1.csv"))

pdf("Data/MODIS/Global_Fire_Atlas/PropHM_PixelOverlap-offset-LTRp1.pdf", width=10, height=10)
plotProps(propsDat, "propHM")
dev.off()

pdf("Data/MODIS/Global_Fire_Atlas/PropHF_PixelOverlap-offset-LTRp1.pdf", width=10, height=10)
