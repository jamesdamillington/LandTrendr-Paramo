...
```
```{r}
propsDat <- read_csv(paste0("Data/MODIS/Global_Fire_Atlas/PixelOverlap_Props.csv"))

pdf("Data/MODIS/Global_Fire_Atlas/PropHM_PixelOverlap.pdf", width=10, height=10)
plotProps(propsDat, "propHM")
dev.off()

pdf("Data/MODIS/Global_Fire_Atlas/PropHF_PixelOverlap.pdf", width=10, height=10)
