...
```
So, in 2016 we have a full-year window with all cloud-free images:
...
dat_Jan_1018 %>%
  ...
  scale_y_continuous(name="Image Proportion") +
  ggtitle("Entire Image, Window Length 4") +
  geom_text(aes(label=round(prop,2),x=Year,y=prop), position=position_dodge(width=0.8), vjust=-0.3)
