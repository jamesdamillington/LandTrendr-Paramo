...
- Read .tif files for each year/window
- Extract cellIDs for all pixels with count == 0 in a given year
- First, count number of years with count == 0
  - plot histogram of these counts
  - plot map of these counts
